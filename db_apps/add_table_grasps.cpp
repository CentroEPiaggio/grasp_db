...
#define EE_ID 1
#define EE_FRAME "right_hand_palm_link"
#define JOINTS {"right_hand_synergy_joint"}
#define DB_NAME "containerB.db"
#define OBJECT_ID 2
#define SPECULARIZE false

std::vector<int> object_ids(1,2,3,4,5,6,7,8,9);

int main(int argc, char **argv)
{
  std::cout<<std::endl;
  std::cout<<"|Grasp db| -> create table grasps and transitions "<<std::endl;
  std::cout<<std::endl;

  ros::init(argc, argv, "create table grasps and transitions");
